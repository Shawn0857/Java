...
public class BasePlusCommissionEmployeeFrame extends EmployeeFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BasePlusCommissionEmployeeFrame frame = new BasePlusCommissionEmployeeFrame();
	 ...
	 * Create the frame.
	 */
	public BasePlusCommissionEmployeeFrame() {
		super();
		setTitle("A109222010_BasePlusCommission");
