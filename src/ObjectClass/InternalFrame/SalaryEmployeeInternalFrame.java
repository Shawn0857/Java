...
public class SalaryEmployeeInternalFrame extends EmployeeInternalFrame {

	private JLabel lblpayMonthPerYear;
	private JLabel lblsalary;
	private JTextField tfpayMonthPerYear;
	private JTextField tfsalary;
	static String strFrameTitle = "A109222010_SalaryEmployee";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SalaryEmployeeInternalFrame frame = new SalaryEmployeeInternalFrame();
	 ...
	 * Create the frame.
	 */
	public SalaryEmployeeInternalFrame() {
		super();
