...
public class HourlyEmployeeInternalFrame extends EmployeeInternalFrame {

	private JLabel lblWage;
	private JLabel lblHours;
	private JTextField tfWage;
	private JTextField tfHours;
	static String strFrameTitle = "A109222010_HourlyEmployee";
	
	ArrayList<HourlyEmployee> rd = new ArrayList<>();
	String[] strTitle = { "姓氏", "名字", "ID", "時薪", "時數" };
	 ...
	 * Create the frame.
	 */
	public HourlyEmployeeInternalFrame() {
		//super();
