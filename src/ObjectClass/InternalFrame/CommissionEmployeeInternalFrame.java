...
public class CommissionEmployeeInternalFrame extends EmployeeInternalFrame {
	...
	static String strFrameTitle = "A109222010_CommissionEmployee";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CommissionEmployeeInternalFrame frame = new CommissionEmployeeInternalFrame();
	 ...
	 * Create the frame.
	 */
	public CommissionEmployeeInternalFrame() {
		super();
